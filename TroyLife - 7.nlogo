breed [trendy setter] ;;People with eternal style
breed [notrendy dud] ;;People with eternal style
breed [cells cell]    ;; Normal People
breed [babies baby]   ;; People trying a new style

patches-own [
  living?         ;; indicates if the cell is living
  static?         ;;
  resistent?      ;; some things never change
...
to setup-blank
  ...
  set-default-shape trendy "lv"
  set-default-shape notrendy "th"
...
to setup-random
  ...
  ask patches
    [ ifelse random-float 100.0 < initial-density
      ...
      [ cell-death ] ]
   ask patches
  [ ifelse random-float 100.0 < setup-resistent
    [ cell-resistent
     sprout-notrendy 1 ]
     [cell-dynamic]
    ]
  ask patches
    [ if random-float 100.0 < static-density
      [ cell-static
        sprout-trendy 1 ]]
  reset-ticks
end
...
to go
    ask notrendy  with [color != fgcolor]
   [ die ]
    ask babies
    [ set breed cells
      set color fgcolor ]
