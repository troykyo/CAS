...
to setup-random
  ...
  ask patches
    [ if random-float 100.0 < NoStyle
      [set dynamic? false
        sprout-stucks 1 ]]

  ask patches
    [ if random-float 100.0 < ClassicStyle
      [set dynamic? false
        sprout-eternals 1 ]]
...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "plot count turtles / count patches"
...
false
0
Rectangle -1 true false 0 75 150 225
Rectangle -2674135 true false 150 75 300 225
